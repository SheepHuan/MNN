...
enum OpType {
  ...
  OpType_PicScoreAttention = 605,
  OpType_PicSparseAttention = 606,
  OpType_MIN = OpType_AbsVal,
  OpType_MAX = OpType_PicSparseAttention
};
...
inline const OpType (&EnumValuesOpType())[186] {
  static const OpType values[] = {
    ...
    OpType_LayerNorm,
    OpType_GridSample,
    OpType_PicScoreAttention,
    OpType_PicSparseAttention
  };
  return values;
}
...
inline const char *EnumNameOpType(OpType e) {
  if (e < OpType_AbsVal || e > OpType_PicSparseAttention) return "";
