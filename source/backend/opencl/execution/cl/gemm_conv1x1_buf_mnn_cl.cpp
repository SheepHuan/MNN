...
"#define UCHAR2_TO_FLOAT4(b, scale, offset) "" wei.s0 = CONVERT_FLOAT((b.s0 >> 4) - 8); "" wei.s1 = CONVERT_FLOAT((b.s0 & 15) - 8); "" wei.s2 = CONVERT_FLOAT((b.s1 >> 4) - 8); "" wei.s3 = CONVERT_FLOAT((b.s1 & 15) - 8); "" wei=wei*scale+offset;\n"
