// Historical kernel: pooling (max variant, FP32)
// Origin: sources/mnn/1.2.0/source/backend/opencl/execution/cl/pooling_buf.cl
// Macro branches baked:
//   FLOAT=float, FLOAT4=float4
//   POOL_AVG: not defined (max pool path)
//   MNN_SUPPORT_FP16: not defined
// Entry: pooling
#ifndef MNN_KERNEL_POOLING_MAX_FP32_120
#define MNN_KERNEL_POOLING_MAX_FP32_120
...
#endif // MNN_KERNEL_POOLING_MAX_FP32_120
